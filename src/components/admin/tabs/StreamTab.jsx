...
import { sanitizeRichHtml as sanitizeHtml } from '@/utils/sanitizeHtml'
...
// The rich text editor + HTML sanitizer now live in shared primitives
// (@/components/primitives/RichTextEditor + @/utils/sanitizeHtml) so the Stream,
// Activities, and Quizzes all use the exact same editor. `sanitizeHtml` above is
// imported as an alias of the shared sanitizer for this file's render points.
