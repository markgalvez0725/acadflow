  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 12.5, color: 'var(--ink3)', lineHeight: 1.55, margin: '0 0 14px' }}>
        Files you attach to a Stream post are stored in your own Drive, in a folder called <strong style={{ color: 'var(--ink2)' }}>/AcadFlow Stream</strong>, and shared as view-only. Students only ever see the preview, never your other files.
      </p>
      ...
      {conn.connected ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, background: 'var(--bg2)', borderRadius: 8, padding: '9px 12px', fontSize: 12.5, color: 'var(--ink2)' }}>
            <FolderOpen size={15} style={{ color: 'var(--accent)' }} /> /AcadFlow Stream
          </div>
